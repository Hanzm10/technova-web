...
const TypingReveal = () => {
    ...
    const charVariants = {
        hidden: { opacity: 0.15 }, // Start light grey (low opacity)
        visible: { opacity: 1 }     // Animate to full opacity (black)
    };
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="mt-24 flex justify-between items-end px-2">
             ...
             <div className="hidden md:block">
                  <span className="text-9xl font-bold text-slate-200 tracking-tighter select-none">2025</span>
             </div>
        </div>
      </div>
    </section>
